...
public class AssignmentOperator {
	...
	public static void main(String[] args) {
		...
		String speed = "ToolsQA"; //String can not be assign to integer
		int name = 10; // Integer can not be assign to String
		//boolean isGood = "ToolsQa" // String can not be assign to Boolean
